...
<form action='sellpro.php' autocomplete="off" method="POST">
...
<input type="text" autocomplete="off" style="text-transform:capitalize;" class="form-control ttx" maxlength="100" required="required" id="ptitl" placeholder="Enter Project Title" name="ptitle" value=""/>
