<?php
$subject = "PBNG JOBS PAYMENT - $amc_b $amp_b WAS DEDUCTED FROM YOUR WALLET FOR JOB PAYMENT";

$message = "
<html>
<head>
<title>PBNG JOBS PAYMENT - $amc_b $amp_b WAS DEDUCTED FROM YOUR WALLET FOR JOB PAYMENT</title>
</head>
<body>
...
Congratulations! $amc_b $amp_b was deducted from your wallet as payment for the project titled $ptit that was completed successfully.Thank you.
<br/><br/>
<style type='text/css'>
.br{
