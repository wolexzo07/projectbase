<?php
$subject = "YOU JUST EARNED NGN $bco REFERRAL BONUS!";

$message = "
<html>
<head>
<title>YOU JUST EARNED NGN $bco REFERRAL BONUS!</title>
</head>
<body>
...
<div style='padding:1%;'>
<p>
Hi &nbsp;<b>$referred_user_name!</b>,<br/><br/>
Congratulations! You just earned referral bonus of <b>NGN $bco</b> from a user called <b>$buyer_name ($user)</b>.Thank you.
<br/><br/>
<style type='text/css'>
.br{
...
if(x_count("mailer","status='1' LIMIT 1") > 0){
	  ...
	  $mailsend =   sendmail($referred_user,$subject,$message);
  if($mailsend==0){
