<?php
$subject = "PBNG REFERRAL - YOU JUST EARNED REFERRAL BONUS OF NGN $refamt";

$message = "
<html>
<head>
<title>PBNG REFERRAL - YOU JUST EARNED REFERRAL BONUS OF NGN $refamt</title>
</head>
<body>
...
<div style='padding:1%;'>
<p>
Hi &nbsp;<b>$refname ($refuser)</b>,<br/><br/>
Congratulations $refname! You just earned a referral bonus of NGN $refamt from $user_name ($user) and NGN $refamt has been credited to your wallet.Thank you.
<br/><br/>
<style type='text/css'>
.br{
...
if(x_count("mailer","status='1' LIMIT 1") > 0){
		$mailsend =   sendmail($refuser,$subject,$message);
  if($mailsend==0){
